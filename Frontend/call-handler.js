...
socket.on('call-reaction', (data) => {
    ...
    handleIncomingCall(data) {
        ...
        this.updateMediaSession(callerDisplayName, "Incoming Call...");
    ...
    dynBg.style.opacity = '1';
            ...
            dynBg.style.opacity = '0';
                ...
                this.expandCall();
        this.updateMediaSession(recipientName, "Dialing...");
    ...
    async startAgoraStream(channelName) {
        try {
            ...
            this.updateMediaSession(document.getElementById('activeCallerName').innerText, "Active Call");
...
async toggleScreenShare() {
    ...
    async endCall(shouldEmit = true, isRejected = false) {
        ...
        // Force browser to release media session and clear notification bar
        [this.sounds.ringtone, this.sounds.dialtone].forEach(s => {
            s.pause();
            s.src = ""; 
            s.load();
        });
        // Re-assign sources for next use
        this.sounds.ringtone.src = 'https://assets.mixkit.co/active_storage/sfx/1359/1359-preview.mp3';
        this.sounds.dialtone.src = 'https://assets.mixkit.co/active_storage/sfx/1354/1354-preview.mp3';
